...
export const DUSK_LAYOUTS={
 ...
 balcony:[
  {id:'original',name:'落地窗茶角',short:'原坐席 · 落地窗景',title:'坐席不变，让窗景通透起来',copy:'保留原长凳和小边几，主视面默认落地固定玻璃，窄通风扇放在侧边。',benefit:'保留喜欢的原家具，窗边视觉更连贯。',tradeoff:'落地外窗为待核验设想，窗下结构、玻璃防护和物业条件须先确认。',checks:['核对外窗开启、排水与渗漏状况','家具避开窗扇开启与通行范围','确认遮阳和夜间隐私需求'],items:[['坐席','可移动长凳或轻椅'],['边几','便于收起的小茶几'],['窗帘','纱帘与遮阳分开考虑']]},
