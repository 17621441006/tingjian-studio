...
export const MODEL_COLORS={"edition-oak":{"wood": "#c2ad8d", "wall": "#ece7de", "stone": "#c7beb0", "sofa": "#f0e9da"},"edition-smoke":{"wood": "#695446", "wall": "#ece7de", "stone": "#c7beb0", "sofa": "#855b40"},"milan":{"wood": "#76533e", "wall": "#ece7de", "stone": "#c7beb0", "sofa": "#70383d"},dusk:{wood:'#624736',wall:'#e7e0d3',stone:'#a79d8f',sofa:'#9a5833'},chinese:{wood:'#804732',wall:'#efe8dc',stone:'#cec6b5',sofa:'#99866f'},stone:{wood:'#655c4e',wall:'#dfdcd2',stone:'#a6a396',sofa:'#9f9683'},collector:{wood:'#4e362a',wall:'#e8e0d2',stone:'#bdb5a5',sofa:'#663735'},copper:{wood:'#665548',wall:'#dbd8cc',stone:'#656e65',sofa:'#4e5847'},amber:{wood:'#c3a77c',wall:'#eee7d9',stone:'#cfccc3',sofa:'#a96948'},graphite:{wood:'#46372e',wall:'#d0c9bd',stone:'#76716a',sofa:'#785235'}};
export function wholeModelSpec(snapshot){
 ...
 const sofa=independent?living.pieces.sofa:'design',table=independent?living.pieces.table:['copper','amber'].includes(snapshot.design)?'glass':'stone',floor=independent?living.pieces.floor:({'edition-oak':'oak','edition-smoke':'smoked',milan:'smoked'})[snapshot.design]||(snapshot.design==='amber'?'oak':'stone');
 ...
 return {design:snapshot.design,scenes,floorByRoom:Object.fromEntries(Object.entries(scenes).map(([id,scene])=>[id,floorProduct(scene.floorProduct)])),palette,woodHome:['edition-oak','edition-smoke','milan'].includes(snapshot.design),sofa,sofaColor:sofaColors[sofa],sofaTextile:['blend','slim','mink'].includes(sofa)||sofa==='design'&&['stone','chinese','copper','edition-oak','milan'].includes(snapshot.design),sofaLength:snapshot.design==='amber'?2.05:sofa==='blend'?2.10:sofa==='slim'||snapshot.design==='graphite'?2.08:2.12,table,floor,removed:living.removed,
  secondPlan:({'edition-oak':'foldaway','edition-smoke':'library',milan:'work',stone:'zen',collector:'library',copper:'work',amber:'dressing',graphite:'foldaway'})[snapshot.design]||'classic',balconyPlan:({'edition-oak':'reading','edition-smoke':'record',milan:'lounge',stone:'lounge',collector:'record',copper:'tea-pair',amber:'woven',graphite:'reading'})[snapshot.design]||(balcony.layout==='glazing'?'tea':'bench'),
