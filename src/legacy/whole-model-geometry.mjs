...
export function buildWholeGeometry(snapshot,textures={},options={}){
 ...
 function wall(room,a,b,height=1.05){const length=Math.hypot(b[0]-a[0],b[1]-a[1]),mesh=box(length,height,.12,(a[0]+b[0])/2,height/2,(a[1]+b[1])/2,m.wall,rooms.get(room));mesh.rotation.y=-Math.atan2(b[1]-a[1],b[0]-a[0]);return mesh;}
